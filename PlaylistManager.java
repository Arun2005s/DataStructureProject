...
class PlaylistManager extends Frame implements ActionListener {
    ...
    public Button uploadButton, shuffleButton, sortButton, playButton, pauseButton, countButton, removeButton, nextButton, prevButton;
    ...
    public PlaylistManager() {
        ...
        shuffleButton = new Button("Shuffle Songs");
